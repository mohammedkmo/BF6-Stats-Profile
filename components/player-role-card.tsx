...
import type { PlayerRole } from '@/types/player-stats';
...
export function PlayerRoleCard({ playerRole }: PlayerRoleCardProps) {
      ...
      <CardContent className="p-6">
        <div className={`flex items-start gap-4`}>
          ...
          <div className={`space-y-2`}>
            <div>
              <p className="text-xs font-medium text-zinc-500 tracking-wide uppercase">{t('section.playerRole')}</p>
